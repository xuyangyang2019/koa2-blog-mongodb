...
module.exports = {
    ...
    'GET /api/backend/article/item': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendArticle.getItem(ctx)
        // })
    },
    // 管理时, 发布文章
    'POST /api/backend/article/insert': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendArticle.insert(ctx)
        // })
    },
    // 管理时, 删除文章
    'GET /api/backend/article/delete': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendArticle.deletes(ctx)
        // })
    },
    // 管理时, 恢复文章
    'GET /api/backend/article/recover': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendArticle.recover(ctx)
        // })
    },
    // 管理时, 编辑文章
    'POST /api/backend/article/modify': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendArticle.modify(ctx)
        // })
    },
    // ------- 分类 -------
    // 管理时, 获取分类列表
    'GET /api/backend/category/list': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendCategory.getList(ctx)
        // })
    },
    // 管理时, 获取单个分类
    'GET /api/backend/category/item': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendCategory.getItem(ctx)
        // })
    },
    // 管理时, 添加分类
    'POST /api/backend/category/insert': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendCategory.insert(ctx)
        // })
    },
    // 管理时, 删除分类
    'GET /api/backend/category/delete': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendCategory.deletes(ctx)
        // })
    },
    // 管理时, 恢复分类
    'GET /api/backend/category/recover': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendCategory.recover(ctx)
        // })
    },
    // 管理时, 编辑分类
    'POST /api/backend/category/modify': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendCategory.modify(ctx)
        // })
    },
    // ------- 管理 -------
    // 后台登录
    'POST /api/backend/admin/login': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendUser.login(ctx)
        // })
    },
    // 管理列表
    'GET /api/backend/admin/list': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendUser.getList(ctx)
        // })
    },
    // 获取单个管理员
    'GET /api/backend/admin/item': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendUser.getItem(ctx)
        // })
    },
    // 编辑管理员
    'POST /api/backend/admin/modify': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendUser.modify(ctx)
        // })
    },
    // 删除管理员
    'GET /api/backend/admin/delete': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendUser.delete(ctx)
        // })
    },
    // 恢复管理员
    'GET /api/backend/admin/recover': async ctx => {
        ...
        // ctx.rest({
        //     list: await backendUser.recover(ctx)
        // })
    },
    // 用户列表
    'GET /api/backend/user/list': async ctx => {
        ...
        // ctx.rest({
        //     list: await frontendUser.getList(ctx)
        // })
    },
    // 获取单个用户
    ...
    'POST /api/backend/user/modify': async ctx => {
        ...
        // ctx.rest({
        //     list: await frontendUser.modify(ctx)
        // })
    },
    // 删除用户
    'GET /api/backend/user/delete': async ctx => {
        ...
        // ctx.rest({
        //     list: await frontendUser.deletes(ctx)
        // })
    },
    // 恢复用户
    'GET /api/backend/user/recover': async ctx => {
        ...
        // ctx.rest({
        //     list: await frontendUser.recover(ctx)
        // })
    },
    // ------ 评论 ------
    // 删除评论
    'GET /api/backend/comment/delete': async ctx => {
        ...
        // ctx.rest({
        //     list: await frontendComment.deletes(ctx)
        // })
    },
    // 恢复评论
    'GET /api/backend/comment/recover': async ctx => {
        ...
        // ctx.rest({
        //     list: await frontendComment.recover(ctx)
        // })
    }
}
